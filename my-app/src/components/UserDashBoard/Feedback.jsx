    ...
    return (
       ...
       <thead>
         <tr>
           ...
           <th scope="col">Feedback Request</th>
...
<Link className="btn"             to={`/user/userdashboard/feedback/${item.id}`}    /* style={{ backgroundColor: 'white' }} */>
                          <VscFeedback style={{ marginRight: '5px', height: "30px", width: "25px" }}/>
                            ...
                            <td>
                             ...
                             <Link className="btn"             to={`/user/userdashboard/viewfeedback/${item.id}`}  /*   style={{ backgroundColor: 'blue' }} */>
                                                       <CiViewList style={{ marginRight: '5px', height: "30px", width: "25px" }}/>
